...
public class BootstrapLoadingUI : MonoBehaviour
{
    ...
    {
        if (nextSceneBuildIndex < 0 || nextSceneBuildIndex >= UnityEngine.SceneManagement.SceneManager.sceneCountInBuildSettings)
        {
            Debug.LogError(
                $"BootstrapLoadingUI: nextSceneBuildIndex {nextSceneBuildIndex} is out of range (0..{UnityEngine.SceneManagement.SceneManager.sceneCountInBuildSettings - 1}). " +
    ...
    private IEnumerator LoadNextScene()
    {
        ...
        AsyncOperation operation =
            UnityEngine.SceneManagement.SceneManager.LoadSceneAsync(nextSceneBuildIndex);
